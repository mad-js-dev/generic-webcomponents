(function(c,u){typeof exports=="object"&&typeof module<"u"?module.exports=u():typeof define=="function"&&define.amd?define(u):(c=typeof globalThis<"u"?globalThis:c||self,c.GenericWebComponentsVue=u())})(this,function(){"use strict";class c extends HTMLElement{static get observedAttributes(){return["reverse-heading","single-item","accordion"]}constructor(){super(),this.attachShadow({mode:"open"}),this._isUpdating=!1,this._handleItemToggle=this._handleItemToggle.bind(this);const e=document.createElement("div"),i=document.createElement("slot"),t=document.createElement("style");t.textContent=`
      :host {
        display: block;
        width: 100%;
        --indent-size: 1.5rem;
