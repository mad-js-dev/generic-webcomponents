import"./IconLabel-DYi3NRef.js";class e extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          max-width: 1200px;
...
&gt;&lt;/icon-label&gt;</code></pre>
    ...
    `}}customElements.define("icon-label-page",e);
